...
| [The Geometry of Truth: Emergent Linear Structure in Large Language Model Representations of True/False Datasets](https://arxiv.org/abs/2310.06824) | [@newsletter-demo](https://github.com/newsletter-demo) | `geometry_of_truth-newsletter-demo-qwen_1_5b` | 1 | v0.1 (simulation) | Minimal single-claim replication run as a newsletter-onboarding simulation. Tests whether a logistic-regression probe classifies city-country truth claims above chance on Qwen-2.5-1.5B-Instruct (50 per class, layer scan). Out of scope: cross-dataset generalization, causal steering. | [draft.md](writeup/geometry_of_truth/geometry_of_truth-newsletter-demo-qwen_1_5b/draft.md) | [config/](config/papers/geometry_of_truth/replications/geometry_of_truth-newsletter-demo-qwen_1_5b/) |  |
