...
| [The Geometry of Truth: Emergent Linear Structure in Large Language Model Representations of True/False Datasets](https://arxiv.org/abs/2310.06824) | [@newsletter-demo-v2](https://github.com/newsletter-demo-v2) | `geometry_of_truth-newsletter-demo-v2-qwen_1_5b` | 1 | v0.2 (post-#8 verification) | Second newsletter-onboarding simulation, run against main after PR #8 (path-routing + template + Python-version fixes). Verifies a cold cloner can open a working PR without moving files manually. | [draft.md](writeup/geometry_of_truth/geometry_of_truth-newsletter-demo-v2-qwen_1_5b/draft.md) | [config/](config/papers/geometry_of_truth/replications/geometry_of_truth-newsletter-demo-v2-qwen_1_5b/) |  |
