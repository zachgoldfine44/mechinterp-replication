...
| [The Geometry of Truth (Marks & Tegmark 2023)](https://arxiv.org/abs/2310.06824) | [@tulaneadam](https://github.com/tulaneadam) | 1 (1.5B) | v1 | Probes achieve 97% accuracy on truth classification. Causal steering passed threshold. Generalization across test sets failed (0.50 vs 0.70 threshold). | [draft.md](writeup/geometry_of_truth/draft.md) | [config/](config/papers/geometry_of_truth/) | |
| *Your paper here* | *(you)* | | | | | | |
