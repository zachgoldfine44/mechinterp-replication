...
**Harness commit:** `d361e01` (this branch)
...
Regeneration script: [scripts/geometry_of_truth/convert_stimuli.py](../../scripts/geometry_of_truth/convert_stimuli.py).
Stimuli JSONs are committed to the repo under
[config/papers/geometry_of_truth/stimuli/](../../config/papers/geometry_of_truth/stimuli/).
...
Set in [paper_config.yaml](../../config/papers/geometry_of_truth/paper_config.yaml)
...
All primary results are committed under [`results/geometry_of_truth/qwen_1_5b/`](../../results/geometry_of_truth/qwen_1_5b/):
...
- [`config/papers/geometry_of_truth/paper_config.yaml`](../../config/papers/geometry_of_truth/paper_config.yaml) — claims and thresholds
- [`config/papers/geometry_of_truth/stimuli/`](../../config/papers/geometry_of_truth/stimuli/) — 500 total stimuli (200 training + 300 held-out)
- [`scripts/geometry_of_truth/convert_stimuli.py`](../../scripts/geometry_of_truth/convert_stimuli.py) — regenerates all stimuli from source CSVs

Reproducing this run end-to-end:

```bash
git checkout replication/geometry-of-truth-qwen-1_5b
python -m src.core.pipeline --paper geometry_of_truth --model qwen_1_5b
