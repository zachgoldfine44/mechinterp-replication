...
Downloads cities.csv from the paper's GitHub (Marks & Tegmark 2023) and
subsamples 50 true + 50 false statements (seed=42), emitting one JSON file
per concept in the format the harness's probe_classification experiment
expects:

    [{"concept": "true",  "text": "The city of ... is in ..."},
     {"concept": "false", "text": "The city of ... is in ..."}, ...]
